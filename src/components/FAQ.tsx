...
const FAQ_ITEMS = [
  {
    ...
    a: 'Я перезвоню вам по телефону в течение 15 минут после заявки. Разговор длится до 45 минут. Вы можете задать до 3 ключевых вопросов по темам: отношения, деньги, карьера, будущее.',
  },
  {
  ...
  },
  {
    ...
    a: 'Оплата происходит после консультации, если вы остались довольны. На сайте нет онлайн-оплаты — вы платите удобным вам способом после разговора со мной.',
  },
  {
